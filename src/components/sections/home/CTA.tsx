          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-800/60 p-10 shadow-2xl shadow-black/60 sm:p-14 relative overflow-hidden">
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  href="tel:7705984665"
                  className="inline-flex items-center justify-center gap-2.5 h-13 rounded-xl bg-white px-8 text-base font-bold text-slate-950 shadow-xl shadow-black/20 transition-all duration-200 hover:bg-slate-100 hover:-translate-y-0.5 active:scale-[0.98]"
                >
